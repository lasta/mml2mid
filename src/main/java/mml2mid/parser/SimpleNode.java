...
public
class SimpleNode extends mml2mid.expr.BaseNode implements Node {

  protected Node parent;
  protected Node[] children;
  protected int id;
  protected Object value;
  protected MmlParser parser;

  public SimpleNode(int i) {
    id = i;
  }

  public SimpleNode(MmlParser p, int i) {
    this(i);
    parser = p;
  }
  ...
  public Object jjtAccept(MmlParserVisitor visitor, Object data)
{
  ...
  /** Accept the visitor. **/
  public Object childrenAccept(MmlParserVisitor visitor, Object data)
{
    if (children != null) {
  ...
  public String toString() {
    return MmlParserTreeConstants.jjtNodeName[id];
  }
...
/* JavaCC - OriginalChecksum=fffac72b49d5960edc43d3612cdd046a (do not edit this line) */
